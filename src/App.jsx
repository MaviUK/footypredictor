...
function positionText(season) { return season?.finishingPosition ? `${season.finishingPosition}${season.tableSize ? `/${season.tableSize}` : ''}` : '-' }
